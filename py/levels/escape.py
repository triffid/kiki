...
world.addObjectAtPos (KikiStone(), world.decenter ( 0, s.y/2 - 1, 0))
world.addObjectAtPos (KikiStone(), world.decenter ( 1, s.y/2 - 1, 0))
world.addObjectAtPos (KikiStone(), world.decenter ( 0, s.y/2 - 1, 1))
world.addObjectAtPos (KikiStone(), world.decenter ( 0, s.y/2 - 1,-1))
world.addObjectAtPos (KikiStone(), world.decenter (-1, s.y/2 - 1, 0))

world.addObjectLine (KikiStone, world.decenter (-2, s.y/2 - 1,-2), world.decenter ( 2, s.y/2 - 1,-2))
world.addObjectLine (KikiStone, world.decenter ( 2, s.y/2 - 1,-2), world.decenter ( 2, s.y/2 - 1, 2))
world.addObjectLine (KikiStone, world.decenter ( 2, s.y/2 - 1, 2), world.decenter (-2, s.y/2 - 1, 2))
world.addObjectLine (KikiStone, world.decenter (-2, s.y/2 - 1, 2), world.decenter (-2, s.y/2 - 1,-2))
